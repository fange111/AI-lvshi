          ...
          <form onSubmit={handleSubmit}>
              ...
              {hasError && (
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-slate-700 dark:text-slate-100">
                    服务器繁忙，请稍后再试! 或者<a href="https://www.aiclubpro.com" target='_blank' className='underline underline-offset-4 decoration-slate-400/50 hover:text-indigo-500 hover:decoration-indigo-500'>自行部署</a>
                  </span>
                </div>
              )}
            ...
            <DialogFooter>
              <div className="text-xs text-gray-500 mt-4 md:m-0 dark:text-gray-100">
                * 回答由 AI 检索法律文件后生成，不保证准确率，仅供参考学习！<a href="https://www.aiclubpro.com" className='ml-1 underline decoration-wavy decoration-indigo-500 underline-offset-2 hover:text-indigo-500' target='_blank'>打赏赞助</a>
              </div>
